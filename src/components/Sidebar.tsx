...
const MODAL_CONTENT = {
  terms: {
    ...
    content: `
# Условия использования MoGPT

**Последнее обновление: Январь 2026**

## 1. Принятие условий

Используя MoGPT, вы соглашаетесь с настоящими условиями. Если вы не согласны — не используйте сервис.

## 2. Описание сервиса

MoGPT — это AI-ассистент нового поколения, предоставляющий:
...
MoGPT предоставляется "как есть". Мы не несём ответственности за:
...
© 2026 MoGPT. Все права защищены.
  ...
  privacy: {
    ...
    content: `
# Политика конфиденциальности MoGPT
